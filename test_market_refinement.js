...
const dataOff = window.generateMarketData(100, 30, { ...baseConfig, ENFORCE_MAX_BAD_STREAK: false });
...
const dataOn = window.generateMarketData(100, 30, { ...baseConfig, ENFORCE_MAX_BAD_STREAK: true });
...
const dataBad = window.generateMarketData(100, 10, badConfig);
